    ...
    return (
      <div className="card p-6">
        <div className="animate-pulse">
          <div className="h-6 bg-secondary-200 rounded w-1/3 mb-6" />
              ...
              <li key={activity.id}>
                <div className="relative pb-8">
                  ...
                  <div className="relative flex space-x-3">
                    <div>
                      <span className={`h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white dark:ring-secondary-800 ${colors}`}>
                    ...
                    <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                      ...
                      <div className="whitespace-nowrap text-right text-sm text-secondary-500 dark:text-secondary-400">
