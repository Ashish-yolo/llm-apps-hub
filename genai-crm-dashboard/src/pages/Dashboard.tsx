  ...
  if (metricsLoading) {
    return (
      <div className="animate-pulse">
        <div className="h-8 bg-secondary-200 rounded w-1/4 mb-6" />
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="h-32 bg-secondary-200 rounded-lg" />
          ))}
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="card p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-2 h-2 bg-warning-600 rounded-full mt-2" />
                <div>
                  <p className="text-sm text-secondary-700 dark:text-secondary-300">
              ...
              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-2 h-2 bg-success-600 rounded-full mt-2" />
                <div>
                  <p className="text-sm text-secondary-700 dark:text-secondary-300">
